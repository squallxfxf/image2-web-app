...
export default function LoginPage() {
  ...
  return (
    <main className="mx-auto mt-16 max-w-md rounded border bg-white p-6">
      ...
      <input value={email} onChange={(e) => setEmail(e.target.value)} className="mb-2 w-full rounded border p-2" />
      <input value={password} onChange={(e) => setPassword(e.target.value)} type="password" className="mb-2 w-full rounded border p-2" />
